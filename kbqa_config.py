...
class BaseConfig:  # 基本配置类
    ...
    THRESHOLD_SEMANTICS_UNDERSTANDER_TALK = 0.8  # 闲聊意图-语义理解算法的分数阈值，大于这个分数的问题才会被匹配到
    THRESHOLD_SEMANTICS_UNDERSTANDER_TALK_MIN = 0.6  # 降级阈值，闲聊意图-语义理解算法的分数阈值，大于这个分数的问题才会被匹配到
